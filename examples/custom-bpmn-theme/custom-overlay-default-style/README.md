...
:warning: In order to avoid having to many content in the README, we simplify it. You can find all the content of the example in [custom-overlay-default-style.js](custom-overlay-default-style.js).
