...
function loadMainBpmnDiagram() {
    bpmnVisualization.load(getMainBpmnDiagram(), {fit: {type: 'Center'}});
    ...
    switch(tabIndex) {
        ...
        case 'secondary':
            if(!secondaryBpmnDiagramIsLoad) {
                ...
                bpmnVisualization.load(getCalledBpmnDiagram(), {fit: {type: 'Center', margin: 10}});
