...
```html
<script src="https://unpkg.com/bpmn-visualization@0.12.1/dist/bpmn-visualization.min.js"></script>
```

💡 During the development step, you can use the non-minified version:
```html
<script src="https://unpkg.com/bpmn-visualization@0.12.1/dist/bpmn-visualization.js"></script>
```
