...
```html
<script src="https://cdn.jsdelivr.net/npm/bpmn-visualization@0.18.0/dist/bpmn-visualization.min.js"></script>
```

💡 During the development step, you can use the non-minified version:
```html
<script src="https://cdn.jsdelivr.net/npm/bpmn-visualization@0.18.0/dist/bpmn-visualization.js"></script>
```
