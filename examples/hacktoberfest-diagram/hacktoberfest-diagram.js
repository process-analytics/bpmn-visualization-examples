...
<bpmn:definitions xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL" xmlns:bpmndi="http://www.omg.org/spec/BPMN/20100524/DI" xmlns:dc="http://www.omg.org/spec/DD/20100524/DC" xmlns:di="http://www.omg.org/spec/DD/20100524/DI" id="Definitions_14mbaax" targetNamespace="http://bpmn.io/schema/bpmn" exporter="bpmn-js (https://demo.bpmn.io)" exporterVersion="7.3.0">
  <bpmn:process id="process_1" isExecutable="false">
    ...
    <bpmn:userTask id="user_task_2" name="Find a issue labeled &#39;hacktoberfest&#39; 🔍">
  ...
  <bpmndi:BPMNDiagram id="BPMNDiagram_1">
    <bpmndi:BPMNPlane id="BPMNPlane_1" bpmnElement="process_1">
      ...
      <bpmndi:BPMNEdge id="edge_sequence_flow_2" bpmnElement="sequence_flow_2">
        ...
        <bpmndi:BPMNLabel>
          <dc:Bounds x="322" y="152" width="15" height="14" />
        </bpmndi:BPMNLabel>
      </bpmndi:BPMNEdge>
      ...
      <bpmndi:BPMNEdge id="edge_sequence_flow_8" bpmnElement="sequence_flow_8">
        <di:waypoint x="795" y="385" />
        <di:waypoint x="795" y="240" />
        <bpmndi:BPMNLabel>
          <dc:Bounds x="802" y="343" width="15" height="14" />
        </bpmndi:BPMNLabel>
      </bpmndi:BPMNEdge>
      ...
      <bpmndi:BPMNEdge id="edge_sequence_flow_9" bpmnElement="sequence_flow_9">
        ...
        <bpmndi:BPMNLabel>
          <dc:Bounds x="710" y="388" width="18" height="14" />
        </bpmndi:BPMNLabel>
      </bpmndi:BPMNEdge>
      ...
      <bpmndi:BPMNShape id="shape_start_event" bpmnElement="start_event">
        ...
        <bpmndi:BPMNLabel>
          <dc:Bounds x="145" y="235" width="105" height="30" />
        </bpmndi:BPMNLabel>
      </bpmndi:BPMNShape>
      <bpmndi:BPMNShape id="shape_exclusive_gateway_1" bpmnElement="exclusive_gateway_1" isMarkerVisible="true">
        ...
        <bpmndi:BPMNLabel>
          <dc:Bounds x="300" y="242" width="100" height="45" />
        </bpmndi:BPMNLabel>
      </bpmndi:BPMNShape>
      ...
      <bpmndi:BPMNShape id="shape_user_task_2" bpmnElement="user_task_2">
        <dc:Bounds x="735" y="170" width="130" height="70" />
        <bpmndi:BPMNLabel>
          <dc:Bounds x="745" y="195" width="110" height="45" />
        </bpmndi:BPMNLabel>
      </bpmndi:BPMNShape>
      <bpmndi:BPMNShape id="shape_call_activity" bpmnElement="call_activity">
        <dc:Bounds x="935" y="275" width="130" height="70" />
        <bpmndi:BPMNLabel>
          <dc:Bounds x="945" y="285" width="110" height="45" />
        </bpmndi:BPMNLabel>
      </bpmndi:BPMNShape>
      <bpmndi:BPMNShape id="shape_exclusive_gateway_3" bpmnElement="exclusive_gateway_3" isMarkerVisible="true">
        <dc:Bounds x="770" y="385" width="50" height="50" />
        <bpmndi:BPMNLabel>
          <dc:Bounds x="753" y="445" width="85" height="27" />
        </bpmndi:BPMNLabel>
      </bpmndi:BPMNShape>
      <bpmndi:BPMNShape id="shape_user_task_4" bpmnElement="user_task_4">
        <dc:Bounds x="550" y="370" width="115" height="70" />
        <bpmndi:BPMNLabel>
          <dc:Bounds x="560" y="395" width="95" height="45" />
        </bpmndi:BPMNLabel>
      </bpmndi:BPMNShape>
      <bpmndi:BPMNShape id="shape_end_event" bpmnElement="end_event">
        <dc:Bounds x="182" y="387" width="36" height="36" />
        <bpmndi:BPMNLabel>
          <dc:Bounds x="159" y="430" width="82" height="40" />
        </bpmndi:BPMNLabel>
      </bpmndi:BPMNShape>
      <bpmndi:BPMNShape id="shape_user_task_1" bpmnElement="user_task_1">
        <dc:Bounds x="420" y="84" width="120" height="70" />
      </bpmndi:BPMNShape>
      <bpmndi:BPMNShape id="shape_user_task_5" bpmnElement="user_task_5">
        <dc:Bounds x="305" y="365" width="150" height="80" />
        <bpmndi:BPMNLabel>
          <dc:Bounds x="315" y="390" width="130" height="55" />
        </bpmndi:BPMNLabel>
      </bpmndi:BPMNShape>
    </bpmndi:BPMNPlane>
  </bpmndi:BPMNDiagram>
